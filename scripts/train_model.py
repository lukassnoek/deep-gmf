...
TARGET_INFO = {
    ...
    'tex': {'n_out': 1970, 'loss': 'mse', 'metric': 'cosine_similarity'},
    'shape': {'n_out': 394, 'loss': 'mse', 'metric': 'cosine_similarity'},
    '3d': {'n_out': 2364, 'loss': 'mse', 'metric': 'cosine_similarity'},
    'xr': {'n_out': 1, 'loss': AngleLoss(), 'metric': None},
    'yr': {'n_out': 1, 'loss': AngleLoss(), 'metric': None},
    'zr': {'n_out': 1, 'loss': AngleLoss(), 'metric': None},
    'xt': {'n_out': 1, 'loss': 'mse', 'metric': 'mae'},
    'yt': {'n_out': 1, 'loss': 'mse', 'metric': 'mae'},
}
